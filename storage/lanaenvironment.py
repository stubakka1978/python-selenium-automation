...
def browser_init(context, test_name):
    ...
    # context.driver = webdriver.Firefox(executable_path='/Users/svetlanalevinsohn/JobEasy/12-python-selenium-automation/geckodriver')
...
def after_step(context, step):
    if step.status == 'failed':
        ...
        print('\nStep failed: ', step)
        # Mark test case as FAILED on BrowserStack: context.driver.execute_script( 'browserstack_executor: {"action":
        # "setSessionStatus", "arguments": {"status":"failed", "reason": "Step failed"}}')
